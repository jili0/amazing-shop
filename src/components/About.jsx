...
import about_bottom_phone from "../assets/about_bottom_phone.png";
  ...
  return (
    <div className="about p-2 my-3">
      ...
      <div className="about-middle">
        <div className="about-middle-top my-2 p-2">
          <div className="imgContainer p-4 ml-2">
            <img
              width="150"
              height="150"
          ...
          <p className="mb-3">
            ...
            temporibus, eligendi accusantium, a modi nostrum quos eius iure
            laudantium ab. Voluptas delectus voluptatibus, doloribus provident
            vitae eum vel consectetur.
          </p>
        </div>
        <div className="about-middle-bottom  my-2 p-2">
          <div className="imgContainer p-2 m-2">
            <img
              width="150"
              height="150"
          ...
          <p className="mb-4">
            <span>The Teams</span>
            Neque quae nobis dolor esse? Accusantium quidem inventore qui earum
            quis aut possimus expedita, vitae illum necessitatibus libero facere
            quaerat atque harum vero voluptates laborum fuga maiores sit tempore
            sed natus! Doloremque reprehenderit debitis dignissimos!
          </p>
          <div className="imgContainer p-2 mx-2 my-5">
            <img
              width="150"
              height="150"
          ...
          <p className="mb-3">
            <span>The Teams</span>
            quidem inventore qui earum quis aut possimu sexpedita, vitae illum
            necessitatibus libero facere quaerat atque harum vero quidem
            inventore qui earum quis aut possimusexpedita, vitae illum
            necessitatibus libero facere quaerat atque harum vero voluptates
            laborum fuga maiores sit tempore sed natus! Doloremque reprehenderit
            debitis dignissimos! Tempore praesentium impedit incidunt quod
            aliquid consectetur?
          </p>
        </div>
      </div>
